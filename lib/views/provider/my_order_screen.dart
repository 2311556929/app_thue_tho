    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Chưa có đơn nào',
            style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.grey[600]), // Đã thiết lập màu xám chuẩn
          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // ✅ ĐÃ FIX LỖI SỌC VÀNG ĐEN (RENDERFLEX OVERFLOW) Ở KHU VỰC NÀY
          Padding(
            padding: const EdgeInsets.all(16),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                // Phần Nút bấm sử dụng Expanded để tự động co giãn, không bao giờ bị tràn
                Row(
                  children: [
                    if (order.status == OrderStatus.accepted) ...[
                      Expanded(
                        child: ElevatedButton.icon(
                          ...
                          label: const Text('Hủy đơn', overflow: TextOverflow.ellipsis),
                          onPressed: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                      ...
                      Expanded(
                        child: ElevatedButton.icon(
                          ...
                          label: const Text('Bắt đầu', overflow: TextOverflow.ellipsis),

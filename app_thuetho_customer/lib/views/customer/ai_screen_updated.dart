...
class AiScreenUpdated extends StatefulWidget {
  const AiScreenUpdated({super.key});

  @override
  State<AiScreenUpdated> createState() => _AiScreenUpdatedState();
}

class _AiScreenUpdatedState extends State<AiScreenUpdated> {
  ...
  Future<void> _sendMessage() async {
    ...
    // Gọi API của Gemini với AI Service MỚI
      ...
      appBar: AppBar(
        ...
        title: const Row(
          children: [
            ...
            SizedBox(width: 8),
            Text('Thợ AI - Chuyên Gia Sửa Chữa', style: TextStyle(fontWeight: FontWeight.bold)),
          ],
        ),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    '💡 Mẹo: Chụp ảnh thiết bị để được chẩn đoán chính xác nhất',
